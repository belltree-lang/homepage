...
PHASE2_PLANS = {
    ...
    "frailty": [
        photo_band("瞬間", "section-shots/frailty-bottle-handover.png",
                   "ペットボトルの蓋を開けてもらうために手渡す手元",
                   "先に気づくのは、まわり",
                   "「これ、開けて」と、ペットボトルを渡されることが増えた。歩幅が、敷居をまたぐだけの幅になっていた——弱り始めのサインは、本人より先に、まわりが気づきます。"),
