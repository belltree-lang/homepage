...
| `/q/lsh/` | 鍼灸マッサージ院・LINE | `lin.ee/8oxBpns`（@083oynfl・経路「名刺」） |
| `/q/lky/` | 居宅介護支援・LINE | `lin.ee/8oxBpns`（@083oynfl・経路「名刺」） |
| `/q/lrg/` | べるリーガル・LINE | `lin.ee/ZRDwfEu`（@683gbqvt・経路「名刺」） |
| `/q/lft/` | べるフィット・LINE | `lin.ee/U0MOk0K`（@936dgdxs・経路「名刺」） |

## LINEの経路について

3アカウントとも、経路名 `名刺`・流入元は空欄で揃えてある。
管理画面の 分析 → 友だち → 追加経路 で、名刺から来た友だちが数えられる。

| アカウント | 経路 | URL | 作成 |
|---|---|---|---|
| @083oynfl べるつりー鍼灸マッサージ院 | 名刺 | `lin.ee/8oxBpns` | 2026-09-18 |
| @936dgdxs べるフィット | 名刺 | `lin.ee/U0MOk0K` | 2026-09-18 |
| @683gbqvt べるリーガル | 名刺 | `lin.ee/ZRDwfEu` | 2026-08-19 |

居宅は自分のアカウントを持たないので `lky` も @083oynfl の「名刺」を指す。
LINE側では鍼灸の面と居宅の面が区別されない。区別が要るようになったら経路を分ける。
